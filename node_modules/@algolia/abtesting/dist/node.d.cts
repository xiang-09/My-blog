...
declare function createAbtestingV3Client({ appId: appIdOption, apiKey: apiKeyOption, authMode, algoliaAgents, region: regionOption, ...options }: CreateClientOptions & RegionOptions): {
     ...
     */
    addABTestsWithHTTPInfo(addABTestsRequest: AddABTestsRequest, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<ABTestResponse>>;
    /**
     ...
     */
    deleteABTestWithHTTPInfo({ id }: DeleteABTestProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<ABTestResponse>>;
    /**
     ...
     */
    estimateABTestWithHTTPInfo(estimateABTestRequest: EstimateABTestRequest, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<EstimateABTestResponse>>;
    /**
     ...
     */
    getABTestWithHTTPInfo({ id }: GetABTestProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<ABTest>>;
    /**
     ...
     */
    getTimeseriesWithHTTPInfo({ id, startDate, endDate, metric }: GetTimeseriesProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<Timeseries>>;
    /**
     ...
     */
    listABTestsWithHTTPInfo({ offset, limit, indexPrefix, indexSuffix, direction }?: ListABTestsProps, requestOptions?: RequestOptions | undefined): Promise<AlgoliaHttpResponse<ListABTestsResponse>>;
    /**
     ...
     */
    stopABTestWithHTTPInfo({ id }: StopABTestProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<ABTestResponse>>;
};
