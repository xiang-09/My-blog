...
function createAnalyticsClient({
  ...
  return {
    ...
    getAddToCartRate({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getAddToCartRate", index);
     ...
     * @param getAddToCartRate.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getAddToCartRate for the plain version.
     */
    getAddToCartRateWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getAddToCartRateWithHTTPInfo", index);
      const requestPath = "/2/conversions/addToCartRate";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getAverageClickPosition({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getAverageClickPosition", index);
     ...
     * @param getAverageClickPosition.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getAverageClickPosition for the plain version.
     */
    getAverageClickPositionWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getAverageClickPositionWithHTTPInfo", index);
      const requestPath = "/2/clicks/averageClickPosition";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getClickPositions({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getClickPositions", index);
     ...
     * @param getClickPositions.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getClickPositions for the plain version.
     */
    getClickPositionsWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getClickPositionsWithHTTPInfo", index);
      const requestPath = "/2/clicks/positions";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getClickThroughRate({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getClickThroughRate", index);
     ...
     * @param getClickThroughRate.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getClickThroughRate for the plain version.
     */
    getClickThroughRateWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getClickThroughRateWithHTTPInfo", index);
      const requestPath = "/2/clicks/clickThroughRate";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getConversionRate({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getConversionRate", index);
     ...
     * @param getConversionRate.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getConversionRate for the plain version.
     */
    getConversionRateWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getConversionRateWithHTTPInfo", index);
      const requestPath = "/2/conversions/conversionRate";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getNoClickRate({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getNoClickRate", index);
     ...
     * @param getNoClickRate.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getNoClickRate for the plain version.
     */
    getNoClickRateWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getNoClickRateWithHTTPInfo", index);
      const requestPath = "/2/searches/noClickRate";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getNoResultsRate({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getNoResultsRate", index);
     ...
     * @param getNoResultsRate.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getNoResultsRate for the plain version.
     */
    getNoResultsRateWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getNoResultsRateWithHTTPInfo", index);
      const requestPath = "/2/searches/noResultRate";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
     ...
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     */
    getPatternsFields(requestOptions) {
     ...
     */
    getPatternsFieldsWithHTTPInfo(requestOptions) {
      const requestPath = "/3/patterns/fields";
      const headers = {};
      const queryParameters = {};
      const request = {
    ...
    getPurchaseRate({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getPurchaseRate", index);
     ...
     * @param getPurchaseRate.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getPurchaseRate for the plain version.
     */
    getPurchaseRateWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getPurchaseRateWithHTTPInfo", index);
      const requestPath = "/2/conversions/purchaseRate";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getRevenue({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getRevenue", index);
     ...
     * @param getRevenue.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getRevenue for the plain version.
     */
    getRevenueWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getRevenueWithHTTPInfo", index);
      const requestPath = "/2/conversions/revenue";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getSearchesCount({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getSearchesCount", index);
     ...
     * @param getSearchesCount.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getSearchesCount for the plain version.
     */
    getSearchesCountWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getSearchesCountWithHTTPInfo", index);
      const requestPath = "/2/searches/count";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getSearchesNoClicks({ index, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getSearchesNoClicks", index);
     ...
     * @param getSearchesNoClicks.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getSearchesNoClicks for the plain version.
     */
    getSearchesNoClicksWithHTTPInfo({ index, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getSearchesNoClicksWithHTTPInfo", index);
      const requestPath = "/2/searches/noClicks";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getSearchesNoResults({ index, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getSearchesNoResults", index);
     ...
     * @param getSearchesNoResults.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getSearchesNoResults for the plain version.
     */
    getSearchesNoResultsWithHTTPInfo({ index, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getSearchesNoResultsWithHTTPInfo", index);
      const requestPath = "/2/searches/noResults";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getStatus({ index }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getStatus", index);
     ...
     */
    getStatusWithHTTPInfo({ index }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getStatusWithHTTPInfo", index);
      const requestPath = "/2/status";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getTopCountries({ index, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopCountries", index);
     ...
     * @param getTopCountries.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getTopCountries for the plain version.
     */
    getTopCountriesWithHTTPInfo({ index, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopCountriesWithHTTPInfo", index);
      const requestPath = "/2/countries";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getTopFilterAttributes({ index, search, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopFilterAttributes", index);
     ...
     * @param getTopFilterAttributes.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getTopFilterAttributes for the plain version.
     */
    getTopFilterAttributesWithHTTPInfo({ index, search, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopFilterAttributesWithHTTPInfo", index);
      const requestPath = "/2/filters";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getTopFilterForAttribute({ attribute, index, search, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("attribute", "getTopFilterForAttribute", attribute);
      (0, import_client_common.validateRequired)("index", "getTopFilterForAttribute", index);
     ...
     * @param getTopFilterForAttribute.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getTopFilterForAttribute for the plain version.
     */
    getTopFilterForAttributeWithHTTPInfo({ attribute, index, search, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("attribute", "getTopFilterForAttributeWithHTTPInfo", attribute);
      (0, import_client_common.validateRequired)("index", "getTopFilterForAttributeWithHTTPInfo", index);
      const requestPath = "/2/filters/{attribute}".replace("{attribute}", encodeURIComponent(attribute));
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getTopFiltersNoResults({ index, search, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopFiltersNoResults", index);
     ...
     * @param getTopFiltersNoResults.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getTopFiltersNoResults for the plain version.
     */
    getTopFiltersNoResultsWithHTTPInfo({ index, search, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopFiltersNoResultsWithHTTPInfo", index);
      const requestPath = "/2/filters/noResults";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getTopHits({ index, search, clickAnalytics, revenueAnalytics, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopHits", index);
     ...
     * @param getTopHits.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getTopHits for the plain version.
     */
    getTopHitsWithHTTPInfo({ index, search, clickAnalytics, revenueAnalytics, startDate, endDate, limit, offset, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getTopHitsWithHTTPInfo", index);
      const requestPath = "/2/hits";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getTopSearches({
      ...
      (0, import_client_common.validateRequired)("index", "getTopSearches", index);
     ...
     * @param getTopSearches.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getTopSearches for the plain version.
     */
    getTopSearchesWithHTTPInfo({
      ...
      (0, import_client_common.validateRequired)("index", "getTopSearchesWithHTTPInfo", index);
      const requestPath = "/2/searches";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
    ...
    getUsersCount({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getUsersCount", index);
     ...
     * @param getUsersCount.tags - Tags by which to segment the analytics.  You can combine multiple tags with `OR` and `AND`. Tags must be URL-encoded. For more information, see [Segment your analytics data](https://www.algolia.com/doc/guides/search-analytics/guides/segments).
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     * @see getUsersCount for the plain version.
     */
    getUsersCountWithHTTPInfo({ index, startDate, endDate, tags }, requestOptions) {
      (0, import_client_common.validateRequired)("index", "getUsersCountWithHTTPInfo", index);
      const requestPath = "/2/users/count";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
     ...
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     */
    queryPatternsDistribution({ distributionPayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("distributionPayload", "queryPatternsDistribution", distributionPayload);
      (0, import_client_common.validateRequired)(
        "distributionPayload.distributions",
        "queryPatternsDistribution",
        distributionPayload.distributions
      );
      (0, import_client_common.validateRequired)("distributionPayload.parameters", "queryPatternsDistribution", distributionPayload.parameters);
     ...
     */
    queryPatternsDistributionWithHTTPInfo({ distributionPayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("distributionPayload", "queryPatternsDistributionWithHTTPInfo", distributionPayload);
      (0, import_client_common.validateRequired)(
        "distributionPayload.distributions",
     ...
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     */
    queryPatternsScalar({ scalarPayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("scalarPayload", "queryPatternsScalar", scalarPayload);
      (0, import_client_common.validateRequired)("scalarPayload.metrics", "queryPatternsScalar", scalarPayload.metrics);
      (0, import_client_common.validateRequired)("scalarPayload.parameters", "queryPatternsScalar", scalarPayload.parameters);
     ...
     */
    queryPatternsScalarWithHTTPInfo({ scalarPayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("scalarPayload", "queryPatternsScalarWithHTTPInfo", scalarPayload);
      (0, import_client_common.validateRequired)("scalarPayload.metrics", "queryPatternsScalarWithHTTPInfo", scalarPayload.metrics);
      (0, import_client_common.validateRequired)("scalarPayload.parameters", "queryPatternsScalarWithHTTPInfo", scalarPayload.parameters);
      const requestPath = "/3/patterns/scalar";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
     ...
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     */
    queryPatternsTable({ tablePayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("tablePayload", "queryPatternsTable", tablePayload);
      (0, import_client_common.validateRequired)("tablePayload.metrics", "queryPatternsTable", tablePayload.metrics);
      (0, import_client_common.validateRequired)("tablePayload.parameters", "queryPatternsTable", tablePayload.parameters);
     ...
     */
    queryPatternsTableWithHTTPInfo({ tablePayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("tablePayload", "queryPatternsTableWithHTTPInfo", tablePayload);
      (0, import_client_common.validateRequired)("tablePayload.metrics", "queryPatternsTableWithHTTPInfo", tablePayload.metrics);
      (0, import_client_common.validateRequired)("tablePayload.parameters", "queryPatternsTableWithHTTPInfo", tablePayload.parameters);
      const requestPath = "/3/patterns/table";
      const headers = {};
      const queryParameters = {};
      if (index !== void 0) {
     ...
     * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
     */
    queryPatternsTimeseries({ timeseriesPayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("timeseriesPayload", "queryPatternsTimeseries", timeseriesPayload);
      (0, import_client_common.validateRequired)("timeseriesPayload.metrics", "queryPatternsTimeseries", timeseriesPayload.metrics);
      (0, import_client_common.validateRequired)("timeseriesPayload.parameters", "queryPatternsTimeseries", timeseriesPayload.parameters);
     ...
     */
    queryPatternsTimeseriesWithHTTPInfo({ timeseriesPayload, index }, requestOptions) {
      (0, import_client_common.validateRequired)("timeseriesPayload", "queryPatternsTimeseriesWithHTTPInfo", timeseriesPayload);
      (0, import_client_common.validateRequired)("timeseriesPayload.metrics", "queryPatternsTimeseriesWithHTTPInfo", timeseriesPayload.metrics);
      (0, import_client_common.validateRequired)(
