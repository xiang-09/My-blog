...
__export(src_exports, {
  ...
  headersFromError: () => headersFromError,
...
var StreamRequestError = class extends AlgoliaError {
...
var DEFAULT_RATE_LIMIT_WAIT_MS = 1e3;
...
var HTTP_429_MESSAGE = /^HTTP 429(?:\D|$)/;
...
function parseRetryAfterMs(headers) {
  var _a;
  const raw = (_a = headers == null ? void 0 : headers["retry-after"]) == null ? void 0 : _a.trim();
