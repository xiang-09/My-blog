...
function createInsightsClient({
  ...
  return {
    ...
    deleteUserToken({ userToken }, requestOptions) {
      (0, import_client_common.validateRequired)("userToken", "deleteUserToken", userToken);
    ...
    pushEvents(insightsEvents, requestOptions) {
      (0, import_client_common.validateRequired)("insightsEvents", "pushEvents", insightsEvents);
      (0, import_client_common.validateRequired)("insightsEvents.events", "pushEvents", insightsEvents.events);
