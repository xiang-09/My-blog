...
function createPersonalizationClient({
  ...
  return {
    ...
    deleteUserProfile({ userToken }, requestOptions) {
      (0, import_client_common.validateRequired)("userToken", "deleteUserProfile", userToken);
    ...
    getUserTokenProfile({ userToken }, requestOptions) {
      (0, import_client_common.validateRequired)("userToken", "getUserTokenProfile", userToken);
    ...
    setPersonalizationStrategy(personalizationStrategyParams, requestOptions) {
      (0, import_client_common.validateRequired)("personalizationStrategyParams", "setPersonalizationStrategy", personalizationStrategyParams);
