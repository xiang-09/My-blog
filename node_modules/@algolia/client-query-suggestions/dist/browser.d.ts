...
declare function createQuerySuggestionsClient({ appId: appIdOption, apiKey: apiKeyOption, authMode, algoliaAgents, region: regionOption, ...options }: CreateClientOptions & RegionOptions): {
     ...
     */
    createConfigWithHTTPInfo(configurationWithIndex: ConfigurationWithIndex, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<BaseResponse>>;
    /**
     ...
     */
    deleteConfigWithHTTPInfo({ indexName }: DeleteConfigProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<BaseResponse>>;
    /**
     ...
     */
    getAllConfigsWithHTTPInfo(requestOptions?: RequestOptions | undefined): Promise<AlgoliaHttpResponse<Array<ConfigurationResponse>>>;
    /**
     ...
     */
    getConfigWithHTTPInfo({ indexName }: GetConfigProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<ConfigurationResponse>>;
    /**
     ...
     */
    getConfigStatusWithHTTPInfo({ indexName }: GetConfigStatusProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<ConfigStatus>>;
    /**
     ...
     */
    getLogFileWithHTTPInfo({ indexName }: GetLogFileProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<LogFile>>;
    /**
     ...
     */
    updateConfigWithHTTPInfo({ indexName, configuration }: UpdateConfigProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<BaseResponse>>;
};
