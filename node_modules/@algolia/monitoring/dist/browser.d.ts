...
declare const apiClientVersion = "1.59.0";
declare function createMonitoringClient({ appId: appIdOption, apiKey: apiKeyOption, authMode, algoliaAgents, ...options }: CreateClientOptions): {
     ...
     */
    getClusterIncidentsWithHTTPInfo({ clusters }: GetClusterIncidentsProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<IncidentsResponse>>;
    /**
     ...
     */
    getClusterStatusWithHTTPInfo({ clusters }: GetClusterStatusProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<StatusResponse>>;
    /**
     ...
     */
    getIncidentsWithHTTPInfo(requestOptions?: RequestOptions | undefined): Promise<AlgoliaHttpResponse<IncidentsResponse>>;
    /**
     ...
     */
    getIndexingTimeWithHTTPInfo({ clusters }: GetIndexingTimeProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<IndexingTimeResponse>>;
    /**
     ...
     */
    getLatencyWithHTTPInfo({ clusters }: GetLatencyProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<LatencyResponse>>;
    /**
     ...
     */
    getMetricsWithHTTPInfo({ metric, period }: GetMetricsProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<InfrastructureResponse>>;
    /**
     ...
     */
    getReachabilityWithHTTPInfo({ clusters }: GetReachabilityProps, requestOptions?: RequestOptions): Promise<AlgoliaHttpResponse<{
        [key: string]: {
            [key: string]: boolean;
        };
    }>>;
     ...
     */
    getServersWithHTTPInfo(requestOptions?: RequestOptions | undefined): Promise<AlgoliaHttpResponse<InventoryResponse>>;
    /**
