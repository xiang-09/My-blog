...
function createRecommendClient({
  ...
  return {
    ...
    batchRecommendRules({ indexName, model, recommendRule }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "batchRecommendRules", indexName);
      (0, import_client_common.validateRequired)("model", "batchRecommendRules", model);
    ...
    batchRecommendRulesWithHTTPInfo({ indexName, model, recommendRule }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "batchRecommendRulesWithHTTPInfo", indexName);
      (0, import_client_common.validateRequired)("model", "batchRecommendRulesWithHTTPInfo", model);
      const requestPath = "/1/indexes/{indexName}/{model}/recommend/rules/batch".replace("{indexName}", encodeURIComponent(indexName)).replace("{model}", encodeURIComponent(model));
      const headers = {};
      const queryParameters = {};
      const request = {
    ...
    deleteRecommendRule({ indexName, model, objectID }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "deleteRecommendRule", indexName);
      (0, import_client_common.validateRequired)("model", "deleteRecommendRule", model);
      (0, import_client_common.validateRequired)("objectID", "deleteRecommendRule", objectID);
    ...
    deleteRecommendRuleWithHTTPInfo({ indexName, model, objectID }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "deleteRecommendRuleWithHTTPInfo", indexName);
      (0, import_client_common.validateRequired)("model", "deleteRecommendRuleWithHTTPInfo", model);
      (0, import_client_common.validateRequired)("objectID", "deleteRecommendRuleWithHTTPInfo", objectID);
      const requestPath = "/1/indexes/{indexName}/{model}/recommend/rules/{objectID}".replace("{indexName}", encodeURIComponent(indexName)).replace("{model}", encodeURIComponent(model)).replace("{objectID}", encodeURIComponent(objectID));
      const headers = {};
      const queryParameters = {};
      const request = {
    ...
    getRecommendRule({ indexName, model, objectID }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "getRecommendRule", indexName);
      (0, import_client_common.validateRequired)("model", "getRecommendRule", model);
      (0, import_client_common.validateRequired)("objectID", "getRecommendRule", objectID);
      const requestPath = "/1/indexes/{indexName}/{model}/recommend/rules/{objectID}".replace("{indexName}", encodeURIComponent(indexName)).replace("{model}", encodeURIComponent(model)).replace("{objectID}", encodeURIComponent(objectID));
      const headers = {};
      const queryParameters = {};
      const request = {
    ...
    getRecommendRuleWithHTTPInfo({ indexName, model, objectID }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "getRecommendRuleWithHTTPInfo", indexName);
      (0, import_client_common.validateRequired)("model", "getRecommendRuleWithHTTPInfo", model);
      (0, import_client_common.validateRequired)("objectID", "getRecommendRuleWithHTTPInfo", objectID);
      const requestPath = "/1/indexes/{indexName}/{model}/recommend/rules/{objectID}".replace("{indexName}", encodeURIComponent(indexName)).replace("{model}", encodeURIComponent(model)).replace("{objectID}", encodeURIComponent(objectID));
      const headers = {};
      const queryParameters = {};
      const request = {
    ...
    getRecommendStatus({ indexName, model, taskID }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "getRecommendStatus", indexName);
      (0, import_client_common.validateRequired)("model", "getRecommendStatus", model);
      (0, import_client_common.validateRequired)("taskID", "getRecommendStatus", taskID);
    ...
    getRecommendStatusWithHTTPInfo({ indexName, model, taskID }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "getRecommendStatusWithHTTPInfo", indexName);
      (0, import_client_common.validateRequired)("model", "getRecommendStatusWithHTTPInfo", model);
      (0, import_client_common.validateRequired)("taskID", "getRecommendStatusWithHTTPInfo", taskID);
      const requestPath = "/1/indexes/{indexName}/{model}/task/{taskID}".replace("{indexName}", encodeURIComponent(indexName)).replace("{model}", encodeURIComponent(model)).replace("{taskID}", encodeURIComponent(taskID));
      const headers = {};
      const queryParameters = {};
      const request = {
    ...
    searchRecommendRules({ indexName, model, searchRecommendRulesParams }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "searchRecommendRules", indexName);
      (0, import_client_common.validateRequired)("model", "searchRecommendRules", model);
    ...
    searchRecommendRulesWithHTTPInfo({ indexName, model, searchRecommendRulesParams }, requestOptions) {
      (0, import_client_common.validateRequired)("indexName", "searchRecommendRulesWithHTTPInfo", indexName);
      (0, import_client_common.validateRequired)("model", "searchRecommendRulesWithHTTPInfo", model);
      const requestPath = "/1/indexes/{indexName}/{model}/recommend/rules/search".replace("{indexName}", encodeURIComponent(indexName)).replace("{model}", encodeURIComponent(model));
      const headers = {};
      const queryParameters = {};
      const request = {
